                        ...
                        <form action="code.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="small_desc" required class="form-control" rows="4"><?= $row['description']?></textarea>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label for="">Description</label>
                                    <textarea name="description" id="category" required class="form-control" rows="4"><?= $row['description']?></textarea>
                                </div>
                                <div class="col-md-12 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="meta_description" value="<?= $row['meta_description']?>" required class="form-control">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="">Meta Keyword</label>
                                    <input type="text" name="meta_keyword" value="<?= $row['meta_keyword']?>" required class="form-control">
                                </div>
